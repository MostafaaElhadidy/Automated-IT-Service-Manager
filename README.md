...
The diagram below shows the full flow — from user message through triage, RCA, remediation, and human approval, including the async monitoring loop running in the background.

<!-- paste your diagram image here, e.g.: -->
...
| it@synapse.io | it123456 | 🛠️ IT Team |
...
> 💡 **Tip:** If you type something the system has seen before (e.g. *"database connection errors"*), it will suggest a known fix from the knowledge base instantly.
>
...
Supported providers: `groq/...`, `gemini/...`, `ollama/...` — any model supported by [LiteLLM](https://docs.litellm.ai/docs/providers).
